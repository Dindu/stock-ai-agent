...
TOP_STOCK_SYMBOLS = {
    "AAPL", "NVDA", "MSFT", "AMZN", "ONDS",
    "TSLA", "AMD", "PLTR", "NFLX", "GOOGL",
    "AVGO", "SOUN", "INTC", "DRAM", "SPCX",
    "ADBE", "HOOD", "ORCL", "SOFI", "WMT",
    "NIO", "BBAI", "BULL", "APLD", "ASTS", "IONQ", "OKLO",
}
AGGRESSIVE_STOCK_SYMBOLS = {"TSLA", "AMD", "PLTR", "SMCI", "DRAM", "SOFI", "GOOGL"}
DEFAULT_SYMBOLS = "SPY,QQQ,IWM,AAPL,NVDA,MSFT,AMZN,ONDS,TSLA,AMD,PLTR,NFLX,GOOGL,AVGO,SOUN,INTC,DRAM,SPCX,ADBE,HOOD,ORCL,SOFI,WMT,JPM,BAC,XOM,COST,CRM,IREN,TSM,NIO,BBAI,BULL,APLD,ASTS,IONQ,OKLO"
