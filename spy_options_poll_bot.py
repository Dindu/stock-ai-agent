...
TOP_STOCK_SYMBOLS = {
    ...
    "AVGO", "SMCI", "DIS", "COIN", "QCOM",
    "ADBE", "HOOD", "ORCL", "BE", "UBER",
}
AGGRESSIVE_STOCK_SYMBOLS = {"TSLA", "AMD", "PLTR", "SMCI", "COIN", "BE", "UBER"}
DEFAULT_SYMBOLS = "SPY,QQQ,IWM,AAPL,NVDA,MSFT,AMZN,META,TSLA,AMD,PLTR,NFLX,GOOGL,AVGO,SMCI,DIS,COIN,QCOM,ADBE,HOOD,ORCL,BE,UBER"
