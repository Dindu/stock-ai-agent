...
def open_trade_record(symbol, signal, option, score, fill_price, qty, data=None):
    ...
    return {
        ...
        "premium_stop_with_thesis_intact": False,
        "premium_stop_thesis_reason": "",
...
def sync_open_trades_from_alpaca():
    ...
    for p in current_positions:
        ...
        _open_trades[contract_sym] = {
            ...
            "min_pnl_pct": prev.get("min_pnl_pct", 0.0) if prev else 0.0,
            "underlying_mfe_pct": prev.get("underlying_mfe_pct", 0.0) if prev else 0.0,
            ...
            "premium_stop_with_thesis_intact": bool(prev.get("premium_stop_with_thesis_intact", False)) if prev else False,
            "premium_stop_thesis_reason": prev.get("premium_stop_thesis_reason", "") if prev else "",
