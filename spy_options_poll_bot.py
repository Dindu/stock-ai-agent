...
ENABLE_STOCKTWITS_TRENDING = os.getenv("ENABLE_STOCKTWITS_TRENDING", "10") == "1"
...
MAX_DTE = int(os.getenv("MAX_DTE", "21" if SWING_STRATEGY_ENABLED else "3"))
FALLBACK_MAX_DTE = int(os.getenv("FALLBACK_MAX_DTE", "21" if SWING_STRATEGY_ENABLED else "5"))
GAINZ_ALGO_MIN_DTE = int(os.getenv("GAINZ_ALGO_MIN_DTE", "7" if SWING_STRATEGY_ENABLED else "1"))
...
BREAKOUT_PUT_ENTRIES_ENABLED = os.getenv("BREAKOUT_PUT_ENTRIES_ENABLED", "1") == "1"
...
GAINZ_ALGO_ENTRY_ENABLED = os.getenv("GAINZ_ALGO_ENTRY_ENABLED", "0") == "1"
...
def analyze(df, client, symbol):
    ...
    data = {
        ...
        "momentum_2bar_pct": momentum_2bar,
        "ema20_slope_pct": ema20_slope_pct,
